...
- **RunOil owns the SaaS relationship.** The end company is the customer of record for the software subscription and owns its Corpus. _(To confirm: the partner introduces and implements rather than wholesale-reselling the subscription — see Open Decisions.)_
...
- Confirm the subscription relationship: end client as customer of record (partner introduces/implements) vs. partner-as-reseller of the subscription.
